...
* **What has changed, and what is the most important truth we need to learn right now?**
  > The project is a blank slate. The most important truth to learn is whether we can create a tangible, observable artifact of the Helix methodology itself.
